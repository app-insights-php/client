...
{
    public function test_adding_to_failure_cache_when_cache_is_empty() : void
    {
    ...
    public function test_adding_to_failure_cache_when_cache_is_not_empty() : void
    {
        $cacheMock = $this->createMock(CacheInterface::class);
    ...
    public function test_all_when_cache_is_empty() : void
    {
